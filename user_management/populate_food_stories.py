    ...
    stories = [
        {
            ...
            'history': '''
                Bánh mì Việt Nam ra đời vào thời kỳ Pháp thuộc (1858-1954), khi người Pháp mang bánh baguette đến Việt Nam. Tuy nhiên, người Việt đã sáng tạo biến tấu bằng cách thêm nhân phong phú: pate, thịt nguội, chả lụa, rau thơm, dưa chuột, ớt...<br><br>
                
                Đến thập niên 1950-1960, bánh mì trở thành món ăn phổ biến ở miền Nam, đặc biệt tại Sài Gòn. Ngày nay, bánh mì Việt Nam đã trở thành biểu tượng ẩm thực được yêu thích trên toàn thế giới.
            ''',
            'fun_facts': [
            ...
            'video_url': 'https://www.youtube-nocookie.com/embed/H_EgAlaOdFs', 
        ...
        },
        {
            ...
            'history': '''
                Cơm tấm xuất hiện từ đầu thế kỷ 20 tại khu vực Chợ Lớn - Sài Gòn. Ban đầu, "tấm" là những hạt gạo bị vỡ trong quá trình xay xát, được bán với giá rẻ cho người lao động nghèo.
                <br><br>
                Từ món ăn của người lao động, cơm tấm dần trở thành đặc sản đường phố với cách chế biến tinh tế: cơm được nấu mềm dẻo, ăn kèm sườn nướng, bì, chả trứng, nước mắm pha chua ngọt...
                <br><br>
                Ngày nay, cơm tấm không chỉ là món ăn bình dân mà còn xuất hiện trong các nhà hàng cao cấp với nhiều biến tấu sáng tạo.
            ''',
            'fun_facts': [
            ...
            'video_url': 'https://www.youtube-nocookie.com/embed/tU4_UuiTPlI', 
            'unesco_recognized': False,
            'recognition_text': ''
        },
        {
            ...
            'history': '''
                Bún bò Huế xuất hiện từ đầu thế kỷ 20 tại cố đô Huế. Món ăn này mang đậm nét ẩm thực cung đình với sự cầu kỳ trong cách chế biến và trình bày.
                <br><br>
                Điểm đặc biệt của bún bò Huế là nước dùng được ninh từ xương ống bò, thịt bò, giò heo trong nhiều giờ, thêm sả, mắm ruốc và ớt tạo nên hương vị cay nồng đặc trưng.
                <br><br>
                Từ xứ Huế, món ăn này lan rộng ra cả nước và trở thành một trong những món bún nổi tiếng nhất Việt Nam, được UNESCO ghi nhận là Di sản ẩm thực phi vật thể của nhân loại.
            ''',
            'fun_facts': [
            ...
            'video_url': 'https://www.youtube-nocookie.com/embed/X9QnZWyrbYA', 
